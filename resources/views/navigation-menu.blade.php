...
[
        'name'=>'Sobre Nosotros',
        'route'=>route('cap.index'),
        'active'=>request()->routeIs('cap.index')
],
[
        'name'=>'Cursos',
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 relative">
                    ...
                    @else                    
                    <a href="{{ route('login') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Acceso</a>
