  ...
  <div class="container-fluid px-1 py-5 mx-auto">
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            ...
            <div class="card">
              <div class="card-body">
              <form id="formulario" action="{{route('admin.contacto.store')}}"  method="POST" enctype="multipart/form-data" >
                @csrf
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex"> 
                          <label class="form-control-label px-3">Contacto</label> 
                          <input type="text" id="lname" class="form-control" name="contacto" placeholder="Enter your last name" >
                         </div>
                    </div>
