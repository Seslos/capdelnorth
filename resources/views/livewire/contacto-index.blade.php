        ...
        <div class="container my-24 mx-auto md:px-6">
            ...
            <section class="mb-32">
              ...
              <div class="container px-6 md:px-12">
                <div
                  class="block rounded-lg bg-[hsl(0,0%,100%)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[#fffefe] dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
                  <div class="flex flex-wrap">
                    <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                      <form>
                        <div class="relative mb-6" data-te-input-wrapper-init>
                          <label class="text-base font-semibold leading-none text-gray-800 dark:text-black">Name</label>
                          <input type="text" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 block ">
                        </div>
                        <div class="relative mb-6" data-te-input-wrapper-init>
                          <div class="relative mb-6" data-te-input-wrapper-init>
                            <label class="text-base font-semibold leading-none text-gray-800 dark:text-black">email</label>
                            <input type="email" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 block">
                          </div>
                        </div>
                        <div class="relative mb-6" data-te-input-wrapper-init>
                          <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Your message</label>
                          <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-black-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
