<section>
<h1 class="text-2xl font-bold"> AUNDIENCIA DEL CURSO</h1>
<hr class="mt-2 mb-6">
    ...
    <article class="card">
        <div class="card-body bg-gray-100" >
            <form wire:submit.prevent="store">
                <input wire:model="name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="Agregar la Audiencia del curso">
               @error('name')
