<form class="pt-2 relative mx-auto text-gray-600" autocomplete="off">
        ...
        <button
        type="submit"
        class="bg-blue-500 hover:bg-blue-700 text-white font-blod py-2 px-4 rounded absolute right-0 top-0 mt-2">
        Buscar
          </button>
     @if ($search)
        <ul class="absolute z-50  left-0 w-full bg-white mt-1 rounded-lg overflow-hidden">
            @forelse ($this->results as $result)
                    <li class="leading-10 px-5 text-sm cursor-pointer hover:bg-slate-300">
