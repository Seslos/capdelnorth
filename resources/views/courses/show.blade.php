...
<div class="container grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="order-2 lg:col-span-2 lg:order-1">
        ...
        <h1 class="text-xl font-semibold sm:text-2xl mb-4 text-gray-800">Requisitos</h1>
                ...
                <div class="card-body">
                   ...
                   <div class="ml-4">
                    ...
                    <form action="{{route('courses.enrolled',$course)}}" method="post" >
                        ...
                        <a href="{{route('payment.checkout',$course)}}" class="btn btn-danger btn-block mt-4" >
                           Comprar este curso
                        </a>
                    @endif
                    @endcan
            ...
            <aside>
                @foreach ($similares  as $similar)
                    <article class="flex mb-6">
                            <img class="h-32 w-40 object-cover"  src="data:image/png;base64,{{ $course->image->url }}" alt="">
                             <div class="ml-3">
                                <h1>
